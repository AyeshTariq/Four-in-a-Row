...
const player1Image = "image_yellow.jpg"; 
const player2Image = "image_blue.png"; 
...
function initializeGame() 
{
    ...
    turnIndicator.style.color = "brown"; // Turns message color
    message.textContent = "";
    gameOver = false;
    playerTurn = 1;
...
function handleCellClick(event) //
{
    ...
    if (checkWinConditions()) 
        ...
        if (playerTurn === 1) 
            ...
            turnIndicator.style.color = "green"; // Win message color
            renderBoard();    
            return;
    }
    ...
    if (checkDraw()) 
        ...
        turnIndicator.style.color = "red"; // Draw message color
        renderBoard();
        return;
        }
